...
import breeze.features.FeatureVector.Implicits.fromArrayInt
...
case class GibbsSettings(iterations: Int = 500, burnin: Int = 100, lag: Int = 10)

case class LDAModel(assignments: Array[Array[Int]], ndz: DenseMatrix[Int], nvz: DenseMatrix[Int]) {
...
/**
  ...
  */
class GibbsLDA(alpha: Double, beta: Double, noTopics: Int, settings: GibbsSettings) {
  ...
  /**
    ...
    */
  private def conditionalLikelihood(vi: Int, di: Int, nvz: DenseMatrix[Int], ndz: DenseMatrix[Int], nz: DenseVector[Int]) = {
  ...
  private def vocabCounts(docs: IndexedSeq[SparseVector[Int]]): MMap[Int, Int] = {
